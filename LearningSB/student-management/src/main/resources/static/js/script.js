...
if (studentForm) {
  studentForm.addEventListener("submit", function (event) {
    ...
    if (name.length < 3) {
      message.innerText = "Student name must contain at least 3 characters.";
    ...
    if (department === "") {
      message.innerText = "Department is required.";
    ...
    fetch("/students", {
      ...
      .then((data) => {
        message.innerText = "Student created successfully.";

        studentForm.reset();
      })

      .catch((error) => {
        message.innerText = "Error creating student.";
